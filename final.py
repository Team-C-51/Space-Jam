...
l5=Label(f,text="Choose from pop,rock,love,sad:")
...
e5.config(text="Dont enter anyting here")
b6=Button(f,text="Enetr to check",command=click5)
b6.grid(row=5,column=2)
def click6():
    global score
    l7=Label(f,text="The probability of your song bring a hit is:"+str(score)+"%")
    l7.grid(row=7,column=1)
    score=0
b8=Button(f,text="If u are done with all the above info click",command=click6)
